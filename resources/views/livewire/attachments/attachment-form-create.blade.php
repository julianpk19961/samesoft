        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <form wire:submit.prevent="stored" class="w-full py-5" enctype="multipart/form-data">
                <div
                    ...
                    <div class="col-span-12 sm:col-span-10">
                        <x-label for="fileLinkStored" value="{{ __('URL') }}" />
                        <x-input id="fileLinkStored" type="text" class="mb-2 block w-full" wire:model="fileLinkStored"
                            autocomplete="fileLinkStored" />
                        <x-input-error for="fileLinkStored" class="mt-2" />
                    </div>
